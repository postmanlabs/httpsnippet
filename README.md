...
HTTP Request snippet generator for *many* languages & tools including: `cURL`, `HTTPie`, `Javascript`, `Node`, `C`, `Java`, `PHP`, `Objective-C`, `Swift`, `Python`, `Ruby`, `C#`, `Golang`, `OCaml` and [more](https://github.com/Mashape/httpsnippet/wiki/Targets)!
